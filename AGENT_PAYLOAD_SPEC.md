...
| `condition_key` | `string?` | Optional. Present on conditional assertions. The freeform developer-defined condition key (e.g., `"success"`, `"error"`, `"empty"`). Absent on unconditional assertions. |
